...
$product = [
    "title" => "Caustic Soda Flakes (Grasim)",
    "name" => "Sodium hydroxide (NaOH)",
    "brand" => "GRASIM INDUSTRIES LIMITED",
    "hsn" => " 28151110",
    "pack" => "50 Kg HPDE bag",
    "desc" => "Caustic soda, or sodium hydroxide, is used in the manufacture of plastic wrap, soap and paper and is the major ingredient in most oven cleaners and liquid drain cleaners. In chemical manufacturing, it is used in metal processing, oil refining and water treatment. Commercially, it is generally used as either a solid, or a 50-percent aqueous solution.",
    "app" => "Caustic soda (sodium hydroxide) is a versatile alkali. Its main uses are in the manufacture of pulp and paper, alumina, soap and detergents, petroleum products and chemical production. Other applications include water treatment, food, textiles, metal processing, mining, glass making and others.",
    "image" => "assets/img/added/product/Caustic-Soda-Flakes-NaOH.png"
];
?>

<div class="common-hero" style="background-image: url(assets/img/added/product/Caustic-Soda-Flakes-NaOH.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
