...
$product = [
    "title" => "Caustic Soda Lye (EPIGRAL)",
    "name" => "Sodium hydroxide (NaOH)",
    "brand" => "EPIGRAL LIMITED",
    "hsn" => "28151200",
    "pack" => "Barrels",
    "desc" => "Sodium hydroxide is a highly caustic base and alkali that decomposes proteins at ordinary ambient temperatures and may cause severe chemical burns. It is highly soluble in water, and readily absorbs moisture and carbon dioxide from the air.",
    "app" => "Used in the manufacture of sodium salts and detergents, pH regulation, and organic synthesis. In bulk, it is most often handled as an aqueous solution because solutions are cheaper and easier to handle.",
    "image" => "assets/img/added/product/Caustic-Soda-Lye-NaOH.png"
];
?>

<div class="common-hero" style="background-image: url(assets/img/added/product/Caustic-Soda-Lye-NaOH.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
