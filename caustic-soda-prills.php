...
$product = [
    "title" => "Caustic Soda Prills (NaOH)",
    "name" => "Caustic Soda Prills",
    "brand" => "-",
    "hsn" => "28151100",
    "pack" => "25 / 50 kg Bags",
    "desc" => "Caustic Soda Prills (Sodium Hydroxide - NaOH) is a highly corrosive inorganic compound widely used in various industrial applications. It appears as white solid prills and is known for its strong alkaline properties. It is classified as a corrosive substance and can cause severe skin burns and eye damage.",
    "app" => "Used in soap and detergent manufacturing, paper and pulp industry, textile processing, water treatment, and chemical manufacturing.",
