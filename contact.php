...
<body class="body">
    ...
    <div class="common-hero" style="background: url('assets/img/added/breadcrumb.jpg') no-repeat center center;background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-lg-10">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="contact-time mt-30">
                        <!-- <h5 class="text-20 font-semibold title1 leading-20">Lab Open </h5>
                        <ul>
                            <li class="text-16 font-normal pera1 leading-16"><img src="assets/img/icons/time.html"
                                    alt=""> Monday - Friday</li>
                            <li class="text-16 font-normal pera1 leading-16"><img src="assets/img/icons/time.html"
                                    alt=""> 8:00 Am - 5:00 Pm </li>
                        </ul>
                        <div class="blog2-divider"></div> -->

                        <div class="contact-box-p mt-30">
                            <div class="icon">
                                <img src="assets/img/added/pin.svg" alt="">
                            </div>
                            <div class="heading ml-16">
                                <h3 class="text-20 font-semibold title1 leading-20">Location</h3>
                                <a href="#" class="text-16 font-normal inline-block mt-3 pera1 leading-16 line-height-26">GF-10, Bhavani Shopping Complex, Nr. Hotel NyayMandir, Zadeshwar, Bharuch - 392015</a>
                            </div>
                        </div>

                        <div class="contact-box-p mt-30">
                            <div class="icon">
                                <img src="assets/img/added/tel.svg" alt="">
                            </div>
                            <div class="heading ml-16">
                        ...
                        <div class="contact-box-p mt-30">
                            <div class="icon">
                                <img src="assets/img/added/email.svg" alt="">
                            </div>
                            <div class="heading ml-16">
                                <h3 class="text-20 font-semibold title1 leading-20">Mail</h3>
                                <a href="mailto:marketing@puregrade.in"
                                    class="text-16 font-normal inline-block mt-3 pera1 leading-16">marketing@puregrade.in</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form id="contactForm" action="sendMail.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="single-input mt-20">
                                        <label>Message*</label>
                                        <textarea id="form_message" rows="5" name="message" placeholder="Type your message..."></textarea>
                                    </div>
                                    <div class="mt-20">
