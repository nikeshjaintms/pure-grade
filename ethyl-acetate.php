...
$product = [
    "title" => "Ethyl Acetate (C₄H₈O₂)",
    "name" => "Ethyl Acetate",
    "brand" => "-",
    "hsn" => "29153100",
    "pack" => "As per requirement",
    "desc" => "Ethyl Acetate is a clear, colorless, fast-evaporating solvent with a pleasant fruity odor. It is widely used in coatings, inks, adhesives, and pharmaceuticals due to its excellent solvency and low toxicity.",
    "app" => "Used in paints, coatings, printing inks, adhesives, pharmaceuticals, and as an industrial solvent.",
    "image" => "assets/img/added/product/Ethyl-Acetate.png"
];
?>

<div class="common-hero" style="background-image: url(assets/img/added/product/Ethyl-Acetate.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
