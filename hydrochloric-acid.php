...
$product = [
    ...
    "hsn" => "",
    "pack" => "drum",
    "desc" => "Hydrochloric Acid is a strong corrosive acid widely used in industries for cleaning, pickling of steel, and pH control. It is a clear, colorless liquid with a sharp, pungent smell.",
    "app" => "Used in water treatment, metal processing, chemical manufacturing, and removing rust/scale from surfaces.",
    "image" => "assets/img/added/product/Hydrochloric-Acid-(HCl).png"
];
?>

<div class="common-hero" style="background-image: url(assets/img/added/product/Hydrochloric-Acid-(HCl).png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
