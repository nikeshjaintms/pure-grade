            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="common-hero-heading">
                        <h1 class="text-60 sm:text-30 md:text-30 leading-56 font-semibold white">Paint & Coating Industry Solvents</h1>
                        <div class="page-change">
                            <ul>
                                ...
                                <li class="inline-block text-16 leading-16 white font-normal">Industrial Solvents</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="research-box sm:mt-30">
                        <div class="image image-anime _relative">
                            <img class="w-full" src="assets/img/added/product/Ethyl-Acetate.png" alt="">
                        </div>
                        <div class="heading1">
                            <h4><a href="ethyl-acetate.php" class="text-20 leading-20 font-semibold title1">Ethyl Acetate</a></h4>
                            <p class="mb-20 mt-16 text-16 font-normal pera1 leading-26">A fast-evaporating solvent widely used in paints, inks, and coating applications.</p>
                            <a href="ethyl-acetate.php" class="learn text-16 leading-16 font-semibold title1">Read More 
