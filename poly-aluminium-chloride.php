...
$product = [
    ...
    "image" => "assets/img/added/product/Poly-Aluminium-Chloride-Powder.png"
];
?>

<div class="common-hero" style="background-image: url(assets/img/added/product/Poly-Aluminium-Chloride-Powder.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
