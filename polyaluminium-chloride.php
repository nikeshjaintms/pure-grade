...
$product = [
    "title" => "Polyaluminium Chloride SAB 18",
    "name" => "Polyaluminium Chloride SAB 18",
    "brand" => "GRASIM INDUSTRIES LIMITED",
    "hsn" => "28273200",
    "pack" => "50 Kg HPDE bag",
    "desc" => "Polyaluminium chloride (PAC) provides faster flocculation and stronger flocs than alum across many applications. One of the common poly aluminium chloride uses is linked to water purification. PAC is manufactured in both liquid and powder form. The product is used in deodorants and antiperspirants, as a flocculant in water purification, in treatment of drinking/potable water, wastewater treatment and paper sizing..",
    "app" => "",
    "image" => "assets/img/added/product/Poly-Aluminium-Chloride.png"
];
?>

<div class="common-hero" style="background-image: url(assets/img/added/product/Poly-Aluminium-Chloride.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
