...
$product = [
    ...
    "brand" => "GACL ",
    "hsn" => "28364000",
    "pack" => "25 Kg Plastic Bag",
    "desc" => " It is a white salt, which is soluble in water. It is deliquescent, often appearing as a damp or wet solid. Potassium carbonate is mainly used in the production of soap and glass.",
    "app" => "Potassium carbonate is a important raw material in basic inorganic chemical industry, medicine industry and light industry. It has been mainly used in production of optical glass, electrode tube, TV tube, bulb, printing items, dye, ink, photography items, sodium metasilicate, polyester powder, plating, leather, ceramic building materials, crystal, potash soap and drugs.",
    "image" => "assets/img/added/product/Potassium-Carbonate.png"
];
?>

<div class="common-hero" style="background-image: url(assets/img/added/product/Potassium-Carbonate.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
