...
$product = [
    ...
    "name" => "dilute solution as bleach( NaOCl )",
    "brand" => "",
    "hsn" => " 28289090",
    "pack" => "50 KGs",
    "desc" => "Sodium hypochlorite is most often encountered as a pale greenish-yellow dilute solution referred to as liquid bleach, which is a household chemical widely used (since the 18th century) as a disinfectant or a bleaching agent.",
    "app" => "Bleaching ,Cleaning ,Disinfection , Sodium hypochlorite has deodorizing properties, which go hand in hand with its cleaning properties. Waste water treatment,.",
    "image" => "assets/img/added/product/Sodium-Hypochlorite.png"
];
?>

<div class="common-hero" style="background-image: url(assets/img/added/product/Sodium-Hypochlorite.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
